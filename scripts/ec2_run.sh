...
backend_env_args() {
  ...
  local optional=(SPRING_PROFILES_ACTIVE SERVER_PORT CORS_ALLOWED_ORIGIN_PATTERNS AUTH0_ISSUER AUTH0_AUDIENCE OPENAI_API_KEY OPENAI_MODEL OPENAI_BASE_URL THENEWSAPI_API_KEY)
