...
export default function Footer() {
  return (
    <footer role="contentinfo" aria-label="Footer" className="border-t bg-background/95 text-sm text-muted-foreground">
      <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row items-start md:items-center justify-between">
        <div className="mb-4 md:mb-0">
          <a href="/" aria-label="TariffSheriff home" className="flex items-center space-x-3">
              <img src="https://github.com/user-attachments/assets/f63f8f5b-6540-4f21-9f6f-508ea4254337" alt="TariffSheriff logo" className="w-8 h-8 object-contain" />
        ...
        <div className="flex space-x-12">
          ...
          <div>
            ...
            <div className="flex space-x-3 mt-2">
              <span className="hover:opacity-80" aria-hidden="true">
              ...
              <a href="https://github.com/SaaiAravindhRaja/TariffSheriff" aria-label="TariffSheriff on GitHub (opens in new tab)" className="hover:opacity-80" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
