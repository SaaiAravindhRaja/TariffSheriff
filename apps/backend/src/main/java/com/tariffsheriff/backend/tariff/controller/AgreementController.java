...
public class AgreementController {
    ...
    @GetMapping("/by-country/{countryIso3}")
    public List<Agreement> getByCountry(@PathVariable String countryIso3) {
        return agreementService.getAgreementsByCountry(countryIso3);
    }
}
